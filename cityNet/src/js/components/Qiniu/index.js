...
var ReactQiniu = React.createClass({
    ...
    propTypes: {
        ...
        supportClick: React.PropTypes.func,
    ...
    onDrop: function(e) {
        ...
        var maxSizeLimit=formatMaxSize(this.props.maxSize || 0)
        ...
        return (
            <div
                ...
                <input style={{
                    ...
                    opacity: 0,
                    zIndex: 1
                }} type="file" multiple={this.props.multiple} ref="fileInput" onChange={this.onDrop} accept={this.props.accept}/>
                {this.props.children}
            </div>
